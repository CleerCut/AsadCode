...
import CollaborationHistory from "@/components/campaign-refactored/brand-campaign/applications/components/campaign-history/campaign-history.component";
      ...
      <div className="shrink-0 z-10 flex flex-col items-center gap-1 border-b border-gray-100 bg-white px-3 pb-3 pt-3 sm:px-4">
        ...
        <h3 className="text-center">
          ...
          {!HIDE_CREATOR_RATING_UI ? (
            <>
              <span className="ml-1 text-base text-gray-500 sm:text-lg">{creatorData.rating}</span>
        ...
        <p className="-mt-1 line-clamp-2 max-w-md text-center text-xs text-gray-500 sm:text-sm">
          {creatorData?.bio}
        </p>
        <div className="mt-1 rounded-full bg-red-100 px-3 py-1 text-xs font-medium text-red-800">
        ...
        <div className="shrink-0 border-t border-gray-200 bg-white p-3 sm:p-4">
          <div className="grid w-full grid-cols-1 gap-2">
            <CustomButton
              ...
              className="btn-primary !py-2 !text-[11px] sm:!py-1 sm:!text-sm"
            ...
            <CustomButton
              ...
              className="btn-outline !py-2 !text-[11px] sm:!py-1 sm:!text-sm"
